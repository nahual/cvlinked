        ...
        this.run = (profileUrl) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const rawUserProfileData = yield page.evaluate(() => {
                    ...
                    const fullNameElement = profileSection === null || profileSection === void 0 ? void 0 : profileSection.querySelector('div.display-flex.justify-space-between.pt2 > div > div:nth-child(1) > h1');
                ...
                const experiences = rawExperiencesData.map((rawExperience) => {
                    ...
                    let endDate = null;
                    try{
                      startDate = utils_1.formatDate(rawExperience.startDate);
                      endDate = utils_1.formatDate(rawExperience.endDate) || null;
                    }catch(error){}
                ...
                const education = rawEducationData.map(rawEducation => {
                    ...
                    try{
                      startDate = utils_1.formatDate(rawEducation.startDate)
                      endDate = utils_1.formatDate(rawEducation.endDate);
                ...
                const volunteerExperiences = rawVolunteerExperiences.map(rawVolunteerExperience => {
                  ...
                  let durationInDays = null
                  try{
                    startDate = utils_1.formatDate(rawVolunteerExperience.startDate);
                    endDate = utils_1.formatDate(rawVolunteerExperience.endDate);
                    durationInDays = utils_1.getDurationInDays(startDate, endDate)
                  }catch(error){}
